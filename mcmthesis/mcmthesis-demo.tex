...
\begin{figure}[h]
  \small
  \centering
  \includegraphics[width=14cm]{hair_dryer.png}
...
\begin{figure}[h]
  \small
  \centering
  \includegraphics[width=5cm]{micro-1year.png}
  \caption{the impact of low star ratings}
\end{figure}

\begin{figure}[h]
  \small
  \centering
  \includegraphics[width=5cm]{revised-R.png}
  \caption{revised the low star rating}
\end{figure}

\newpage
By comparing the low star ratings with the reputation of microwaves throughout a year, we surprisingly found that the amount of low stars in Jan. 2015 made a great impact on the reputation value. Finding the cause in the dataset, we speculated that the following review may cause a decline in reputation.When we removed this review, the reputation of the product was restored.

\begin{itemize}
\item The handle is attached to the door by two weak screws that bear up against a nonmetallic surface on the door. For my unit, the lower attachment door surface broke within six months and the handle pulled away from the door. 
I am having a service call take care of it but it looks like a design flaw. Even if I get a replacement door, I expect it will break again in six months. Avoid this model design. ...
\item star rating: 1
\item help\_votes: 60, total\_votes: 63
\item not Amazon Vine member and verified\_purchase
\end{itemize}
